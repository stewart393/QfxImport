...
namespace QFXparser
{
    ...
    {        
        ...
        private PropertyResult GetPropertyInfo(string token)
        {
            ...
            if (typeof(RawDownload).GetCustomAttribute<NodeNameAttribute>().CloseTag == token)
            {
                propertyResult.Member = typeof(RawStatement);
                propertyResult.Type = NodeType.StatementClose;
                return propertyResult;
            ...
            if (typeof(RawDownload).GetCustomAttribute<NodeNameAttribute>().OpenTag == token)
            {
                propertyResult.Member = typeof(RawStatement);
                propertyResult.Type = NodeType.StatementOpen;
                return propertyResult;
            ...
            {
                statementMember = typeof(RawDownload).GetProperties().FirstOrDefault(m => m.GetCustomAttribute<NodeNameAttribute>().OpenTag == token);
            }
            if (statementMember != null)
            {
